    ...
    public void apply(ModelPropertyContext context) {
        try {
            ...
            if (annotation.isPresent()) {
                JavaType enumType = findEnumType(context.getBeanPropertyDefinition().get().getPrimaryType());
                if (enumType != null) {
                    ...
                    ListVendorExtension<String> descExtension = new ListVendorExtension<>("ex-enum-descriptions",
